...
public class MethodTester extends Picture
{
  public static void main (String[] args) throws IOException
  {
    ...
    //method tester to make sure "embedDigits2" works for 1 on 13
    ...
    // **** Test cases for method getMostSignificant *******
    result = getMostSignificant2(53);
    System.out.println( "The result of getMostSignificant2(53) is " + result );
    if ( result == 0 ) {
      System.out.println( "This is correct!" );
    }
    else {
      System.out.println( "This is WRONG!  Should be 0" );
    }
